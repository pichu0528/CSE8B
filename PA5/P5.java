/**  
 * Assignment 5           P5.java                     Due Feb. 21, 2013 
 * login:  cs8bbf 
 **/ 
/** 
 * class P5  - Class header comment 
 * This program is using the relations between superclass and subclass, an
 * abstract class, normal classes, constructors, arrays to look for the areas
 * of RegularHex and RegularOctagon, the surface areas and volumes of HexPrism
 * and OctagonalPrism, and the perimeters of RegularHex and RegularOctagon. 
 * 
 **/
